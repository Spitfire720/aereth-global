...
public class CharacterService {
    ...
    public CharacterService(JavaPlugin plugin, StorageService storage, ProgressionService progression, StatsService stats) {
        this.plugin = plugin;
    ...
    public YamlConfiguration createCharacter(OfflinePlayer player, int slot, String race, String name) throws IOException {
        ...
        character.set("race.trait", defaultTraitForRace(cleanRace));
        ...
        account.set("slots." + slot + ".race-trait", defaultTraitForRace(cleanRace));
    ...
    public void ensureBuild1Fields(YamlConfiguration character, OfflinePlayer player, int slot) {
        ...
        character.set("schema-version", character.getInt("schema-version", 1));
        ...
        character.set("name", character.getString("name", "Unnamed " + displayRace(getRace(character))));
    ...
    public String defaultTraitForRace(String race) {
        return switch (normalizeRace(race)) {
            ...
            case "nullborn" -> "Locked";
            case "echoform" -> "Locked";
            case "lumenfae" -> "Locked";
